...
@Component
public class SelfAssessmentFormTemplateReviewCycleMigrationInitializer implements BeanPostProcessor, Ordered {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ...
        try {
            ...
            throw new BeanCreationException("self-assessment form template review cycle migration failed", e);
        }
        return bean;
    }
    ...
    private void migrate(JdbcTemplate jdbc) {
        ...
        addColumnIfMissing(jdbc, "self_assessment_form_template", "review_cycle_id", "BIGINT NULL");
    }
