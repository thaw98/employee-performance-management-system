...
class SelfAssessmentFormAssignmentServiceTest {
        ...
        void assignSelfAssessmentForms_createsFormFromMatchingActiveCycleTemplate() {
                ...
                when(employeeRepository.findEligibleSelfAssessmentAssignees(EmployeeStatus.ACTIVE,
                ...
                SelfAssessmentAssignmentResponse response = service.assignSelfAssessmentForms(request("ALL_EMPLOYEES"),
                                99L);
        ...
        void updateSettings_savesThresholdAndSyncsUnassignedActiveCycleTemplates() {
                ...
                when(settingsRepository.findById(SelfAssessmentSettings.SINGLETON_ID))
        ...
        void hrReturnDisputedReview_requiresNonEmptyReason() {
                ...
                RuntimeException ex = assertThrows(RuntimeException.class,
                                () -> service.hrReturnDisputedReview(200L, new HrReturnDisputedReviewRequest("   "),
                                                99L));
        ...
        void hrReturnDisputedReview_movesFormToManagerReviewAndNotifiesManagerWithBothReasonsWithoutSignature() {
                ...
                service.hrReturnDisputedReview(200L,
                                new HrReturnDisputedReviewRequest("Please revise the rating evidence"), 99L);
                ...
                verify(notificationService).send(
                                ...
                                org.mockito.ArgumentMatchers
                                                .contains("Employee dispute reason: Employee disagrees with rating"),
                                eq("SELF_ASSESSMENT_FORM"),
                                eq(200L));
                verify(notificationService).send(
                                eq(form.getEmployee().getManager().getUserAccount()),
                                eq("Self-Assessment Review Returned"),
                                org.mockito.ArgumentMatchers
                                                .contains("HR return reason: Please revise the rating evidence"),
                                eq("SELF_ASSESSMENT_FORM"),
                                eq(200L));
        }
        ...
        void hrFinalApprovalStillRequiresDefaultSignatureForDisputedForm() {
                ...
                RuntimeException ex = assertThrows(RuntimeException.class,
                                () -> service.hrApproveForm(200L,
                                                new com.epms.backend.dto.selfassessmentform.HrApproveFormRequest(null),
                                                99L));
        ...
        void assignSelfAssessmentForms_rejectsInvalidDeadlineOrder() {
                ...
                RuntimeException ex = assertThrows(RuntimeException.class,
                                () -> service.assignSelfAssessmentForms(request, 99L));
        ...
        void previewSelfAssessmentAssignments_returnsNotAssignedWhenTemplateExistsForSelectedDeadlines() {
                ...
                List<SelfAssessmentAssignmentPreviewDto> preview = service
                                .previewSelfAssessmentAssignments(previewRequest(10L, 20L));
        ...
        void createTemplate_usesGlobalRatingSystemWhenRequestOmitsRatingSystem() {
                ...
                ArgumentCaptor<SelfAssessmentFormTemplate> templateCaptor = ArgumentCaptor
                                .forClass(SelfAssessmentFormTemplate.class);
        ...
        void submitForm_notifiesDirectManagerOnSuccessfulSubmit() {
                ...
                SelfAssessmentForm form = formForSubmit(employee, template(100L, 10L, 20L, cycle), cycle,
        ...
        void submitForm_skipsNotificationWhenResolvedManagerHasNoActiveUserAccount() {
                ...
                verify(notificationService, never()).send(any(), eq("Self-Assessment Submitted"), any(),
                                eq("SELF_ASSESSMENT_FORM"));
        }
        ...
        void managerReview_validatesAdjustmentsAgainstSavedTenPointThreshold() {
                ...
                RuntimeException ex = assertThrows(RuntimeException.class, () -> service.managerReview(
                                ...
                                new ManagerReviewRequest(
                                                "Needs adjustment",
                                                List.of(new ManagerAdjustmentRequest(501L, "Yes", 7,
                                                                "Below saved threshold")))));
        ...
        void managerReview_withAdjustmentsMatchingSelfScores_skipsEmployeeNotifiesHr() {
                ...
                service.managerReview(
                                ...
                                new ManagerReviewRequest(
                                                "Looks good",
                                                List.of(new ManagerAdjustmentRequest(501L, "Yes", 5,
                                                                "Agree with self rating"))));
        ...
        void managerReview_withAdjustments_notifiesEmployeeOnly() {
                ...
                service.managerReview(
                                ...
                                new ManagerReviewRequest(
                                                "Reviewed",
                                                List.of(new ManagerAdjustmentRequest(501L, "No", 1,
                                                                "Needs calibration"))));
        ...
        void getActiveCycleFormsForHr_includesTemplateIdInFormListRows() {
                ReviewCycle cycle = cycle();
                SelfAssessmentFormTemplate template = template(100L, 10L, 20L, cycle);
                SelfAssessmentForm form = formForSubmit(employee(1L, 10L, 20L), template, cycle,
                                SelfAssessmentFormStatus.DRAFT);
        ...
        private static SelfAssessmentFormTemplate template(Long id, Long departmentId, Long positionId,
                        ReviewCycle cycle) {
                Department department = new Department();
                department.setId(departmentId);
