...
export function PermanentTransferModal({ isOpen, employeeId, employeeName, onClose, onSuccess }: PermanentTransferModalProps) {
  ...
  const [permanentTransfer, { isLoading }] = usePermanentTransferMutation()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(e?.data?.message || 'Permanent transfer failed')
    }
  }
        ...
        <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-base font-bold text-gray-900">Permanent Transfer</h2>
          ...
          <div className="mx-6 mt-4 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-xs text-amber-800">
            This action permanently transfers the employee. Their new department becomes their home department.
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Reason for permanent transfer…"
              />
            </div>
