...
function getStatusConfig(status: string) {
  ...
  if (s === 'SUBMITTED' || s === 'EMPLOYEE_SUBMITTED') {
    return {
      ...
      label: 'Submitted',
      bg: 'bg-[#eff6ff] dark:bg-[#2463eb]/20',
      text: 'text-[#1d4ed8] dark:text-[#60a5fa]',
      dot: 'bg-[#2463eb]',
      icon: Clock,
      accent: 'border-l-[#2463eb]',
      ring: 'ring-[#2463eb]/20',
    };
  }
...
/** Avatar gradients derived from primary #2463eb */
const AVATAR_COLORS = [
  'from-[#2463eb] to-[#1d4ed8]',
  'from-[#3b82f6] to-[#2463eb]',
  'from-[#1d4ed8] to-[#1e40af]',
  'from-[#60a5fa] to-[#3b82f6]',
  'from-[#2563eb] to-[#1e40af]',
  'from-[#2463eb] to-[#3b82f6]',
    ...
    <div className="min-h-screen px-6 py-6 md:px-8 animate-fade-in">
      ...
      <div className="mb-8 flex items-center gap-5">
        <div className="relative">
          <div className={`flex h-14 w-14 items-center justify-center rounded-2xl ${kpisGradientBr} shadow-lg shadow-[#2463eb]/20`}>
      ...
      <div className="mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-[#dbeafe]/80 bg-gradient-to-br from-[#eff6ff]/80 to-white p-5 shadow-sm dark:border-[#2463eb]/30 dark:from-[#2463eb]/20 dark:to-slate-800/80">
          <div className="absolute -right-4 -top-4 h-20 w-20 rounded-full bg-[#dbeafe]/60 dark:bg-[#2463eb]/10" />
          <div className="relative flex items-start justify-between">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-widest text-[#2463eb]/80 dark:text-[#60a5fa]/80">
                Awaiting Review
              </p>
              <p className="mt-2 text-3xl font-black tabular-nums text-slate-900 dark:text-white">
                {submittedCount}
              ...
              {totalCount > 0 && (
                <p className="mt-1 text-[10px] font-semibold text-[#1d4ed8]/70 dark:text-[#60a5fa]/60">
                  {Math.round((submittedCount / totalCount) * 100)}% of total
                </p>
              )}
            </div>
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#eff6ff] text-[#2463eb] dark:bg-[#2463eb]/40 dark:text-[#60a5fa]">
              <Clock size={18} />
            </div>
          </div>
        </div>
        ...
        <div className="border-b border-slate-100 dark:border-slate-700/60">
          <div className="flex items-center justify-between px-5 py-4">
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-[#2463eb]/10 to-[#2463eb]/5 dark:from-[#2463eb]/20 dark:to-[#2463eb]/10">
                <BarChart3 size={16} className="text-[#2463eb] dark:text-[#60a5fa]" />
              </div>
              <div>
            ...
            <div className="relative w-72">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200/80 bg-slate-50/50 px-3.5 py-2 pl-9 text-base text-slate-900 shadow-sm transition-all placeholder:text-slate-400 focus:border-[#2463eb] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#2463eb]/20 dark:border-slate-600 dark:bg-slate-900/50 dark:text-white dark:placeholder:text-slate-500 dark:focus:border-[#2463eb] dark:focus:bg-slate-800"
              />
              {searchQuery && (
                <button
                  type="button"
                ...
                >
                  ...
                  <span
                    className={`ml-0.5 rounded-full px-1.5 py-0.5 text-[11px] font-bold tabular-nums ${
                      isActive
                        ? 'bg-[#2463eb]/20 text-[#2463eb] dark:bg-[#2463eb]/30 dark:text-[#60a5fa]'
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-[1fr_0.7fr_0.7fr_0.5fr_0.4fr_40px] items-center gap-3 md:gap-4 px-5 py-3.5">
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        <p className="truncate text-sm font-semibold text-slate-900 dark:text-white group-hover:text-[#2463eb] dark:group-hover:text-[#60a5fa] transition-colors">
                          {name}
                        </p>
                    ...
                    <ChevronRight
                      size={16}
                      className="hidden md:block text-slate-300 transition-transform group-hover:translate-x-0.5 group-hover:text-[#2463eb] dark:text-slate-600 dark:group-hover:text-[#60a5fa]"
                    />
                  </div>
          ...
          <div className="border-t border-slate-100 px-5 py-4 dark:border-slate-700/60">
            ...
            {activeTab !== 'ALL' && (
              <p className="mt-2 text-[11px] text-slate-400 dark:text-slate-500">
                Filtered by{' '}
                <span className="font-semibold text-[#2463eb] dark:text-[#60a5fa]">
